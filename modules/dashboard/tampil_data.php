    ...
    <div class="row align-items-center justify-content-between">
        ...
        <div class="col-lg-9">
            ...
            <p class="text-muted fw-light mb-4">
                Selamat datang di sistem pengelolaan siswa Asrama Hogwards. Kelola data asrama dan siswa dalam suasana Hogwards yang penuh keajaiban.
            </p>
            <p class="text-muted fw-light mb-4">
                #Hogwards #Asrama #Siswa #MagicalSchool
            </p>
            <p class="text-muted fw-light mb-4">
                Sistem ini sekarang menampilkan asrama-asrama terkenal seperti Gryffindor, Hufflepuff, Ravenclaw, dan Slytherin untuk pengalaman sekolah sihir yang lebih hidup.
            </p>
