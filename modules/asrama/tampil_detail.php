...
if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
        ...
        echo '<div class="alert alert-success alert-dismissible rounded-4 fade show mb-4" role="alert">
                <strong><i class="fa-solid fa-circle-check me-2"></i>Sukses!</strong> Data asrama berhasil diubah.
...
<div class="bg-white rounded-4 shadow-sm p-4 mb-4">
    ...
    <div class="alert alert-secondary rounded-4 mb-5" role="alert">
        <i class="fa-solid fa-list-ul me-2"></i> Detail Data Asrama
    </div>
    <!-- tampilkan data -->
    <h6 class="text-muted fw-light mb-2">Asrama</h6>
    <p class="mb-4"><?php echo $data['nama_asrama']; ?></p>
