...
if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
        ...
        echo '<div class="alert alert-success alert-dismissible rounded-4 fade show mb-4" role="alert">
                <strong><i class="fa-solid fa-circle-check me-2"></i>Sukses!</strong> Data asrama berhasil disimpan.
    ...
    elseif ($_GET['pesan'] == 2) {
        ...
        echo '<div class="alert alert-success alert-dismissible rounded-4 fade show mb-4" role="alert">
                <strong><i class="fa-solid fa-circle-check me-2"></i>Sukses!</strong> Data asrama berhasil dihapus.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>';
    }
}
...
<div class="row">
    ...
    */
    ...
    // sql statement untuk menampilkan data dari tabel "tbl_asrama"
    $query = mysqli_query($mysqli, "SELECT id_asrama, nama_asrama FROM tbl_asrama 
                                    ORDER BY id_asrama DESC LIMIT $batas_awal, $batas")
    ...
    if ($rows <> 0) {
        ...
        <div class="d-flex flex-column flex-xl-row align-items-center mt-4">
            ...
            <div class="flex-grow-1 text-center text-xl-start text-muted mb-3">
                <?php
                // sql statement untuk menampilkan jumlah data pada tabel "tbl_asrama"
                $query = mysqli_query($mysqli, "SELECT id_asrama FROM tbl_asrama")
                ...
                */
                ...
                // sql statement untuk menampilkan jumlah data pada tabel "tbl_asrama" yang ditampilkan per halaman
                $query = mysqli_query($mysqli, "SELECT id_asrama FROM tbl_asrama LIMIT $data_awal, $batas")
            ...
            <ul class="pagination justify-content-center">
                ...
                // jika paginasi halaman > 1, maka button link "<" aktif
                    ...
                    <li class="page-item pagination-pill">
                        <a class="page-link" href="?module=asrama&paginasi=<?php echo $paginasi_halaman - 1; ?>" aria-label="Previous">
                            <i class="fa-solid fa-angle-left"></i>
                        </a>
                    </li>
                <?php } ?>
                ...
                */
                ...
                ?>
                    <li class="page-item pagination-pill <?php echo $link_active; ?>">
                        <a class="page-link" href="?module=asrama&paginasi=<?php echo $x; ?>"><?php echo $x; ?></a>
                    </li>
                <?php } ?>
                ...
                // jika "paginasi_halaman" < "jumlah_paginasi_halaman", maka button link ">" aktif
                    ...
                    <li class="page-item pagination-pill">
                        <a class="page-link" href="?module=asrama&paginasi=<?php echo $paginasi_halaman + 1; ?>" aria-label="Next">
                            <i class="fa-solid fa-angle-right"></i>
                        </a>
                    </li>
                <?php } ?>
