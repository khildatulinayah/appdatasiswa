...
if (isset($_POST['simpan'])) {
    ...
    if (move_uploaded_file($tmp_file, $path)) {
        ...
        $insert = mysqli_query($mysqli, "INSERT INTO tbl_siswa(id_siswa, tanggal_daftar, asrama, nama_lengkap, jenis_kelamin, alamat, email, whatsapp, foto_profil) 
                                         VALUES('$id_siswa', '$tanggal_daftar', '$asrama', '$nama_lengkap', '$jenis_kelamin', '$alamat', '$email', '$whatsapp', '$nama_file_enkripsi')")
