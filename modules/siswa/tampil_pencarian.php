...
<div class="row">
    ...
    ?>
        ...
        <?php
        // sql statement untuk menampilkan data dari tabel "tbl_siswa" dan tabel "tbl_asrama" berdasarkan "kata_kunci"
            ...
            while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <div class="col-lg-6 col-xl-3">
                    <div class="bg-white rounded-4 shadow-sm text-center p-4 p-lg-4-2 mb-4">
                        ...
                        <p class="text-muted mb-4"><?php echo $data['nama_asrama']; ?></p>
                        <!-- button detail data -->
