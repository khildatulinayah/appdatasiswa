...
<div class="row">
    ...
    */
    ...
    // sql statement untuk menampilkan data dari tabel "tbl_siswa" dan tabel "tbl_asrama"
    $query = mysqli_query($mysqli, "SELECT a.id_siswa, a.asrama, a.nama_lengkap, a.foto_profil, b.nama_asrama 
