...
Aplikasi pengelolaan data siswa merupakan aplikasi berbasis web yang digunakan untuk memudahkan dalam melakukan pencatatan dan pelaporan data siswa.
...
1. Dashboard,
Halaman yang berisi informasi jumlah data siswa yang ditampilkan per asrama.
...
3. Asrama,
Halaman untuk mengelola data asrama. Pada halaman ini pengguna dapat menginput, mengubah, menghapus, mencari data, dan menampilkan detail data asrama.
