...
try {
    ...
    $mail->setSubject("Test Real SMTP - Aplikasi Data Siswa");
    
    // Message content
    $message = "Ini adalah test email dari Real SMTP Mailer.

Test Code: 123456

Waktu pengiriman: " . date('H:i:s, d M Y') . "

Jika Anda menerima email ini, berarti Real SMTP Mailer berhasil konek ke Gmail SMTP.
...
Mohon jangan balas email ini.";
    ...
    if ($sent) {
        ...
        echo "<li>Jika email diterima, Real SMTP berjalan dengan baik</li>";
        echo "<li>Update forgot password untuk menggunakan Real SMTP</li>";
        echo "</ol>";
        ...
        echo "<ul>";
        echo "<li>Periksa koneksi internet</li>";
        echo "<li>Check firewall tidak blocking port 587</li>";
        echo "<li>Verify Gmail App Password sudah benar</li>";
        echo "<li>Pastikan 2-factor authentication aktif</li>";
        echo "<li>Check email dan password tidak ada typo</li>";
        echo "</ul>";
    }
...
echo "<hr>";
echo "<p><a href='index.php'>Kembali ke Dashboard</a> | <a href='test_smtp_mailer.php'>Test SMTP Mailer</a></p>";
?>
